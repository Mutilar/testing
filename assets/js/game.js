...
(function () {
            ...
            schemes: [
                {
                    dead: '#000000',
                    trail: ['#FFFFFF'],
                    alive: ['#EEEEEE', '#DDDDDD', '#CCCCCC']//'#9898FF', '#8585FF', '#7272FF', '#5F5FFF', '#4C4CFF', '#3939FF', '#2626FF', '#1313FF', '#0000FF', '#1313FF', '#2626FF', '#3939FF', '#4C4CFF', '#5F5FFF', '#7272FF', '#8585FF']
                },
     ...
     * Init on 'load' event
     */
    testing.helpers.registerEvent(window, 'load', function () {
        testing.init();
    }, false);
